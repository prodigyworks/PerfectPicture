<?php
	...
	class QuoteReport extends PDFReport {
		...
		function newPage() {
			...
			$this->addText( 83.5, 272, "Quote valid for 30 days", 8, 3, 'B');

			$this->addText( 15, 13, "ESC Corporation Ltd", 12, 4, 'B') + 5;
			...
			$this->addText( 160, $dynamicY, "QUOTATION", 8, 3, 'B');
			...
			$this->addText( 145, $dynamicY + 10, "Quote Date:", 8, 3, 'B');
			...
			$this->addText( 10, 270, "VAT Registration No: 103 5897 15\nCompany Reg No: 07810887", 7, 3);
				...
				if ($result) {
					while (($this->headermember = mysql_fetch_assoc($result))) {
						...
						$sql = "SELECT A.*, B.productcode, B.description
								FROM {$_SESSION['DB_PREFIX']}quotationitem A 
